  ...
  <div class="landing-page-wrapper">
    <section class="hero-section">
      ...
      <div class="hero-content">
        <h1>Your AI Partner in Navigating <span class="highlight">Bangladeshi Law</span></h1>
        <p>Get instant, clear answers to your legal questions. Whether you're a citizen, a law student, or a legal professional, LegalAI simplifies complexity.</p>
    ...
    <section id="features" class="features-section fade-in-section">
      <div class="section-header">
        <h2>A Tailored Experience for Everyone</h2>
        <p>LegalAI understands your needs and adapts its responses to provide the most relevant and useful information for your role.</p>
      </div>
      <div class="features-grid">
        ...
        <div class="feature-card">
          ...
          <p>Accelerate your learning with detailed case summaries, statutory definitions, and explanations of complex legal doctrines. Your perfect study partner.</p>
        </div>
        <div class="feature-card">
          ...
          <p>Boost your productivity with rapid case law research, citation cross-referencing, and initial drafts for clauses and arguments. Find what you need, faster.</p>
        </div>
      </div>
    </section>
...
// --- Function to initialize the particle animation ---
...
export function renderLandingPage(container: HTMLElement) {
    ...
    // Initialize animations after the content is in the DOM
    initParticles(); 
